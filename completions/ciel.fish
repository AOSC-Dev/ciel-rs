...
complete -c ciel -n "__fish_use_subcommand" -f -a "clean" -d 'Clean all the output directories'
...
complete -c ciel -n "__fish_seen_subcommand_from build" -s c -l resume -d 'Continue from a Ciel checkpoint'
...
complete -c ciel -n "__fish_seen_subcommand_from build" -l stage-select -d 'Select the starting point for a build'
...
complete -c ciel -n "__fish_seen_subcommand_from clean" -s h -l help -d 'Prints help information'
complete -c ciel -n "__fish_seen_subcommand_from clean" -s V -l version -d 'Prints version information'
complete -c ciel -n "__fish_seen_subcommand_from help" -s h -l help -d 'Prints help information'
complete -c ciel -n "__fish_seen_subcommand_from help" -s V -l version -d 'Prints version information'
