...
complete -c ciel -n "__fish_seen_subcommand_from run" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from config" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from commit" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from build" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from rollback" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from down" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from stop" -s i -d 'Instance to be used'
...
complete -c ciel -n "__fish_seen_subcommand_from mount" -s i -d 'Instance to be used'
