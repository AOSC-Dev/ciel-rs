...
complete -c ciel -n "__fish_ciel_using_subcommand update-os" -l rw-tree -d 'Mount TREE as read-write' -r -f -a "{true\t'',false\t''}"
...
complete -c ciel -n "__fish_ciel_using_subcommand instconf" -l rw-tree -d 'Mount TREE as read-write' -r -f -a "{true\t'',false\t''}"
...
complete -c ciel -n "__fish_ciel_using_subcommand add" -l rw-tree -d 'Mount TREE as read-write' -r -f -a "{true\t'',false\t''}"
...
complete -c ciel -n "__fish_ciel_using_subcommand shell" -l rw-tree -d 'Mount TREE as read-write' -r -f -a "{true\t'',false\t''}"
...
complete -c ciel -n "__fish_ciel_using_subcommand build" -l rw-tree -d 'Mount TREE as read-write' -r -f -a "{true\t'',false\t''}"
