...
pub trait Machine {
    ...
    fn get_sshinfo(&self) -> zbus::Result<(String, String)>;
    ...
    /// SSHAddress property
    #[zbus(property, name = "SSHAddress")]
    fn sshaddress(&self) -> zbus::Result<String>;

    /// SSHPrivateKeyPath property
    #[zbus(property, name = "SSHPrivateKeyPath")]
    fn sshprivate_key_path(&self) -> zbus::Result<String>;
